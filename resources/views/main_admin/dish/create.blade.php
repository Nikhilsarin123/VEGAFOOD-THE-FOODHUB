        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('dish.store') }}" enctype="multipart/form-data" method="post">
                 @csrf
                <div class="card-body">
                ...
                <div class="form-group @error('dishname') is-invalid @enderror">
                    <label for="exampleInputEmail1">DishName</label>
                    <input type="Text" class="form-control" id="exampleInputEmail1" name="Speciality" value="Speciality" placeholder="Enter The text Here">
